...
|---------------|-------------|
| **`example/hq/`** | HeroQuest-style stack: many ISL modules, `logic-test/`, React `bin/`, JSON data—advanced **reference POC**. |
...
2. **Study end-to-end codegen**: `example/hq/` is the richest and heaviest; follow [Compilation and codegen](./compilation-workflow.md).
