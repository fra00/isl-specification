export declare function useDungeonSessionManager(config: { gameSession: any; onUpdateSession: (session: any) => void; onNotify: (message: string) => void; fogOfWarLogic: any }): {
