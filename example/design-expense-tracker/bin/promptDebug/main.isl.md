...
<!-- START DEPENDENCY INTERFACE: expense-logic.ref.md -->
<!-- INTERFACE (REF) FOR: expense-logic.isl.md -->
# Project: Expense Logic

**Version**: 1.0.0
**ISL Version**: 1.6.1
<!-- IMPLEMENTATION PATH: ./expense-logic -->
...
<!-- START DEPENDENCY INTERFACE: expense-form.ref.md -->
<!-- INTERFACE (REF) FOR: expense-form.isl.md -->
# Project: Expense Form

**Version**: 1.0.0
**ISL Version**: 1.6.1
<!-- IMPLEMENTATION PATH: ./expense-form -->
...
<!-- START DEPENDENCY INTERFACE: expense-list.ref.md -->
<!-- INTERFACE (REF) FOR: expense-list.isl.md -->
# Project: Expense List

**Version**: 1.0.0
**ISL Version**: 1.6.1
<!-- IMPLEMENTATION PATH: ./expense-list -->
