...
class SemanticSimilarityEvaluator:
    ...
    def evaluate(self, ground_truth: str, agent_answer: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # DEBUG: Stampa lo score per capire come calibrare la soglia
            print(f"   [DEBUG Similarity] Score: {similarity_score:.4f} | GT: '{ground_truth[:20]}...' vs Agent: '{agent_answer[:20]}...'")

            score: int
            explanation: str

            # 4. IF similarity_score IS GREATER THAN 0.85 (Threshold adjusted from 0.95) THEN
...
class LLMJudgeEvaluator:
    ...
    def evaluate(self, question: str, ground_truth: str, agent_answer: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Clean up potential markdown formatting (e.g. ```json ... ```) to avoid JSONDecodeError
