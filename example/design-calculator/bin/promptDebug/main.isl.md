...
<!-- START DEPENDENCY INTERFACE: calculator-logic.ref.md -->
<!-- INTERFACE (REF) FOR: calculator-logic.isl.md -->
# Project: Calculator Logic

**Version**: 1.0.0
**ISL Version**: 1.6.1
<!-- IMPLEMENTATION PATH: ./calculator-logic -->
...
<!-- START DEPENDENCY INTERFACE: calculator-ui.ref.md -->
<!-- INTERFACE (REF) FOR: calculator-ui.isl.md -->
# Project: Calculator Ui

**Version**: 1.0.0
**ISL Version**: 1.6.1
<!-- IMPLEMENTATION PATH: ./calculator-ui -->
