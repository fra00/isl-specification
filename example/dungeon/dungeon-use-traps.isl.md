...
- Capabilities internalState, checkTrapActivation, isTrapVisible, registerTriggeredTrap, attemptDisarmTrap MUST avoid undefined side effects outside declared flow and side effects.
