export declare function useHeroStats(config: { staticEquipment: Array<any> }): {
    calculateStats: (heroState: any) => { attacco: number; difesa: number; movimento: number; mente: number; corpo: number; canAttackDiagonal: boolean; canAttackRanged: boolean; canDisarmTraps: boolean; hasDoubleAttack: boolean };
